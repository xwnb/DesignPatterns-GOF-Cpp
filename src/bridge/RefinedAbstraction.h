...
#ifndef REFINEDABSTRACTION_H_
#define REFINEDABSTRACTION_H_
...
class RefinedAbstraction : public Abstraction {
 ...
 public:
  ...
  RefinedAbstraction(Implementor *implementor)
      : Abstraction(implementor), implementor_(implementor) {
  ...
  virtual void OperationImpB() {
    std::cout << "Here is OperationImpB of Abstraction.\n";
    implementor_->OperationImpB1();
    implementor_->OperationImpB2();
  }
};
#endif  // !REFINEDABSTRACTION_H_